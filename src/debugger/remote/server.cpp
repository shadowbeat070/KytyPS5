...
Json Frame() {
	...
	for (const auto& draw: Graphics::LastFrame()) {
		values.push_back({{"frame", draw.frame}, {"index", draw.index}, {"submit", draw.submit_id},
		                  ...
		                  {"ngg_merged", draw.ngg_merged}, {"mesh", draw.mesh_active},
		                  {"mesh_indexed", draw.mesh_indexed},
		                  {"mesh_workgroups", draw.mesh_workgroups},
		                  {"mesh_verts_per_wg", draw.mesh_verts_per_wg},
		                  {"mesh_prims_per_wg", draw.mesh_prims_per_wg},
		                  {"mesh_out_vertices", draw.mesh_out_vertices},
		                  {"mesh_out_primitives", draw.mesh_out_primitives},
		                  {"targets_valid", draw.targets_valid},
		                  {"color_count", draw.color_count},
		                  {"color_clears", draw.color_clears},
		                  {"color0_addr", draw.color0_addr},
		                  {"color0_clear", draw.color0_clear},
		                  {"color0_blend", draw.color0_blend},
		                  {"color0_srcblend", draw.color0_srcblend},
		                  {"color0_dstblend", draw.color0_dstblend},
		                  {"color0_combfcn", draw.color0_combfcn},
		                  {"has_depth", draw.has_depth},
		                  {"depth_clear", draw.depth_clear},
		                  {"color0_format", draw.color0_format},
		                  {"color0_meta_kind", draw.color0_meta_kind},
		                  {"color0_dcc_addr", draw.color0_dcc_addr},
		                  {"color0_cmask_addr", draw.color0_cmask_addr},
		                  {"color0_dcc_enable", draw.color0_dcc_enable},
		                  {"color0_cmask_fce", draw.color0_cmask_fce},
		                  {"color0_clear_word0", draw.color0_clear_word0},
		                  {"color0_meta_cleared", draw.color0_meta_cleared},
		                  {"render_width", draw.render_width},
		                  {"render_height", draw.render_height},
		                  {"color0_width", draw.color0_width},
		                  {"color0_height", draw.color0_height},
		                  {"viewport_w", draw.viewport_w},
		                  {"viewport_h", draw.viewport_h}});
	}
